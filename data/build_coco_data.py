...
from lib.core.config import KEYPOINTS_LABEL, SMALL_RADIUS_KEYPOINTS, ALL_BODY_LABEL, UPPER_BODY_LABEL, RESIZE_SHAPE
...
def _convert_dataset(loader):
    ...
    if FLAGS.include_keypoint == 'all':
        label_to_heatmap = ALL_BODY_LABEL
    else:
        label_to_heatmap = UPPER_BODY_LABEL
    ...
    for shard_id in range(_NUM_SHARDS):
        ...
        with tf.python_io.TFRecordWriter(output_filename) as tfrecord_writer:
            ...
            for i in range(start_idx, end_idx):
                ...
                heatmaps = np.zeros(RESIZE_SHAPE)

                # create heatmap
                for key_index in label_to_heatmap:
                    keypoint_name = KEYPOINTS_LABEL[key_index]
                    ...
                    if key[2] == 0:
                        ...
                        key[0] = key[0] - bbox_x
                        key[1] = key[1] - bbox_y
                        key_resized_x = key[0]*RESIZE_SHAPE[1]/cropped_img.shape[1]
                        key_resized_y = key[1]*RESIZE_SHAPE[0]/cropped_img.shape[0]
                ...
                heatmaps = heatmaps[: ,:, 1:]
                resized_img = cv2.resize(cropped_img, RESIZE_SHAPE[::-1])
