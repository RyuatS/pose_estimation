...
class StackedHourglass(ParentFCN):
    def __init__(self, is_use_bn, num_keypoints=17):
        ...
        self.model_structure = OrderedDict([
            ...
            ('conv2_2', {'filter_shape': [3, 3, 128, 256], 'strides': [1, 1, 1, 1], 'residual': 'pool1'}),
            ...
            ('conv3_2', {'filter_shape': [3, 3, 128, 256], 'strides': [1, 1, 1, 1], 'residual': 'pool2'}),
            ...
            ('conv4_2', {'filter_shape': [3, 3, 128, 256], 'strides': [1, 1, 1, 1], 'residual': 'pool3'}),
            ...
            ('conv5_3', {'filter_shape': [1, 1,  128,  256],'strides': [1, 1, 1, 1], 'residual': 'pool3'}),
            ...
            ('conv6_3', {'filter_shape': [1, 1,  128,  256],'strides': [1, 1, 1, 1], 'residual': 'pool2'}),
            ...
            ('conv7_3', {'filter_shape': [1, 1,  128,  256],'strides': [1, 1, 1, 1], 'residual': 'pool1'}),
